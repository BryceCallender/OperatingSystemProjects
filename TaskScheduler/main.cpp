...
int main()
{
	std::cout << "\nThe average turn around time is: " << firstComeFirstServedAlgorithm() << std::endl << std::endl;

	std::cout << "\nThe average turn around time is: " << shortestJobFirst() << std::endl << std::endl;

	std::cout << "\nThe average turn around time is: " << roundRobin(2) << std::endl << std::endl;

	std::cout << "\nThe average turn around time is: " << roundRobin(5) << std::endl << std::endl;
